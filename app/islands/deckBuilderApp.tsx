  ...
  return (
    <div class="flex flex-col xl:flex-row gap-4 relative" style="height: calc(100vh - 4rem);">
      ...
      <button
        ...
        class="xl:hidden fixed bottom-4 right-4 z-50 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors"
      ...
      >
        <div class="h-full flex flex-col">
          ...
          <button
            onClick={closeSidebar}
            class="xl:hidden absolute top-2 right-2 z-50 p-2 text-gray-500 hover:text-gray-700"
            aria-label="閉じる"
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
